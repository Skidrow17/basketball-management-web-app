...
<body>
	...
	<nav id='nav_bar' class="navbar navbar-light navbar-expand-md fixed-top navbar-transparency" >
            <div class="container"><a class="navbar-brand" href="http://ekasdym.gr/news/" style="background-color:rgba(255,255,255,0);"><img src="assets/img/ekas.png" height="40px" width="40px" alt="logo"></a><button class="navbar-toggler" data-toggle="collapse" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                <div
   ...
   <div class='form-row'>
    ...
    <form method="post" action="./php/login.php">
        ...
        <div class="form-group"><input class="form-control" type="text" name="username" id="username" placeholder="username" required></div>
    ...
    <form id='hide' method="post">
	   ...
	   <div class='form-row'>
        <div class="col"><button class="btn btn-primary btn-block" id='men_a' value='1' type="button" >A Ανδρών</button></div>
	   </div>
	   
	   <div class='form-row'>
        <div class="col"><button class="btn btn-primary btn-block" id='adult' value='4' type="button" >Εφήβων</button></div>
		<div class="col"><button class="btn btn-primary btn-block" id='men_b' value='2' type="button" >B Ανδρών</button></div>
		<div class="col"><button class="btn btn-primary btn-block" id='woman' value='3' type="button" >Γυναικών</button></div>
	   </div>
	   
	   <div class='form-row'>
        <div class="col"><button class="btn btn-primary btn-block" id='girls' value='8' type="button" >Κορασίδων</button></div>
	    <div class="col"><button class="btn btn-primary btn-block" id='young' value='5' type="button" >Νεανίδων</button></div>
		<div class="col"><button class="btn btn-primary btn-block" id='child' value='7' type="button" >Παίδων</button></div>
	   </div>
...
<nav aria-label="Page navigation example">
  ...
  <table id='table'>
        ...
        <div class="form-group"><button class="btn btn-primary btn-block" id='back' type="button">Πίσω</button></div></form>
