...
$(document).ready(function() {
  $("#incomming,#outgoing").click(function() {
    ...
    if (category == 1) {
      ...
      myFunction("getIncomming_Messages_By_User.php",post_id);
      type1 = "getIncomming_Messages_By_User.php";
    } else if (category == 2) {
      n_o_p("getN_O_Outgoing_Messages_By_User.php");
      myFunction("getOutgoing_Messages_By_User.php",post_id);
...
function myFunction(type,post_id) {
  $.ajax({
    type: "POST",
    url: "php/jquery/" + type,
    data: post_id,
