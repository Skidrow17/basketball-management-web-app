...
<div class="form-row">
    ...
    <div class="annoucements-look element">
        <form method="post" id='single' action="./php/insert/insert_restriction.php" style="display:none;" autocomplete="off">
			<div class="form-row">
			<div class="col-sm-2"><button class="btn btn-primary btn-block" id='back' type="button">Πίσω</button></div>
			</div>
            ...
            <div class="form-row">
				...
				<div class="col"><div class="form-group"><input placeholder='Πατήστε μέσα στο πεδίο' style='border:1px solid rgb(220,110,86);' name='date' type='date' required></div></div>
            </div>
            <div class="form-row">
                <div class="col"><small class="form-text text-muted" style="color:rgb(220,64,29);">Επιλογή ώρας έναρξης</small></div>
			<div class="col"><input type="time" name="time_from" id='time_from' required></div>
            </div>
            <div class="form-row">
				<div class="col"><small class="form-text text-muted" style="text-align:left;">Επιλογή ώρας τερματισμού</small></div>
                <div class="col"> <input type="time" name="time_to" id='time_to' required></div>
				 
            </div>
        
            <div class="form-group"><button class="btn btn-primary btn-block" name='submit' type="submit">Προσθήκη Κωλύματος</button></div>
		</form>
	   ...
	   <div class='form-row'>
        <div class="col"><button class="btn btn-primary btn-block" id='restriction' value='1' type="button">Κώλυμα</button></div>
        <div class="col"><button class="btn btn-primary btn-block" id='multiple_restriction' value='2' type="button">Πολλαπλά Κωλυμάτα</button></div>
	   </div>
	...
	<form method="post" id='multiple' action="./php/insert/insert_multiple_restriction.php" style="display:none;" autocomplete="off">
			<div class="form-row">
			<div class="col-sm-2"><button class="btn btn-primary btn-block" id='back2' type="button">Πίσω</button></div>
			</div>
            ...
            <div class="form-group"><input id='dates' name='dates' placeholder='Πατήστε μέσα στο πεδίο' style='border:1px solid rgb(220,110,86);' type="text" class="datepicker-here form-control" data-language='gr' data-multiple-dates="365" data-multiple-dates-separator=", " data-position='top left' onfocus="blur();" required></div>
	   
            <div class="form-group"><button class="btn btn-primary btn-block" name='submit' type="submit">Προσθήκη Κωλυμάτων</button></div>
          </form>
	</form>
