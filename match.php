...
<body>
    ...
    <div class="annoucements-look">
	  ...
	  <?php include('nav_bar.php'); ?>
        ...
        <form name='button' id='show_games'  style="background-color:rgba(238,238,238,0.74);margin:0px;">
...
<nav aria-label="Page navigation example">
  ...
  <table id='table'>
        ...
        <div class="form-group"><button class="btn btn-primary btn-block" id='back' type="button" style="background-color:rgb(220,110,86);">Πίσω</button></div></form>
