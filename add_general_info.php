    ...
    <div class="admin-look">
        ...
        <?php if(isset($_GET['id'])){ if($_GET['id']==4) { 
			...
			<div class="form-row">
				...
				<div class="col-xl-12"><small class="form-text text-muted">';echo $selectCategory; echo'</small><div class = "selectbox-design">'; echo getAllTeam_Categories(); echo '</div></div>
				<div class="col-xl-12"><small class="form-text text-muted">';echo $select_group; echo'</small><div class = "selectbox-design">'; echo getAllTeam_Group(); echo '</div></div>
			...
			';
				...
				echo '
				<form method="post"  action="php/insert/insert_rate.php">
				 <div class="form-row">
							<div class="col">
