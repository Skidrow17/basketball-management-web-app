...
if(security_check($_SESSION['safe_key'],$_SESSION['user_id'])==true&&$_SESSION['profession']==='Admin')
{
	...
	while($row=$run->fetch(PDO::FETCH_ASSOC)){
		...
		echo '  
            <div class="form-row">
                <div class="col-xl-6"><small class="form-text text-muted">Όνομα&nbsp;</small><input name="name" class="form-control" value="'.$row['name'].'" type="text"></div>
                <div class="col-xl-6"><small class="form-text text-muted">Πόλη</small>';echo getLivingPlace($row['city']); echo '</div>
            </div>
			<div class="form-row">
