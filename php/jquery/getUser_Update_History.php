...
if(security_check($_SESSION['safe_key'],$_SESSION['user_id'])==true)
{
	...
	$sql="SELECT name,surname,password,email,phone,driving_licence,living_place,profession,profile_pic,active,rate,update_time from user_update_history  ORDER BY update_time desc limit :page,9" ;
	$run = $dbh->prepare($sql);
