...
$run ->execute();
   ...
   <div class='container'>
                 <div style='word-wrap:break-word' class='col-xl-12' ><h3 contenteditable='true' id='u_title' >"; echo $row['title']; echo "</h3></div>
                 ...
                 <div style='word-wrap:break-word' class='col-xl-12'><hr><textarea id='message' style='resize:none;' rows='7' class='form-control' style='color:rgb(0,0,0);'>";echo $row['text']; echo"</textarea></div>
			     </div>			 
	</div>";
