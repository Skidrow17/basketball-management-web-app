...
if(security_check($_SESSION['safe_key'],$_SESSION['user_id'])==true)
{
  ...
  JOIN team AS away 
    ON r.team_id_2 = away.id , team t where yearweek(r.date_time,1) = yearweek(curdate(),1) AND r.team_id_1=t.id AND t.category=:td order by get_n_o_r_by_game(r.id) desc";
