...
if (isset($_POST['current_page']) && isset($_SESSION['safe_key']) && isset($_SESSION['user_id'])) {
    if (security_check($_SESSION['safe_key'], $_SESSION['user_id']) == true) {
        ...
        echo '<tr>
		  ...
		  ';
        $sql = "Select R.id,R.time_to,R.time_from,R.date,R.register_timestamp,R.deletable from restriction R where R.user_id=:uid order by R.date desc limit :page,7";
        $run = $dbh->prepare($sql);
