...
if(security_check($_SESSION['safe_key'],$_SESSION['user_id'])==true)
{
   ...
   echo'<tr>
		...
		if($restriction_date==$current_week)
		echo '<td><button value='.$row['id'].' id="delete_btn" type="button" name="delete_btn" class="btn"><i class="fa fa-trash"></i></button></td>';
		else
		echo '<td><button value="-404" id="delete_btn" type="button" name="delete_btn" class="btn"><i class="fa fa-times-circle"></i></button></td>';
