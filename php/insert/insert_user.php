...
if(security_check($_SESSION['safe_key'],$_SESSION['user_id'])==true && $_SESSION['profession']==='Admin')
{
	...
	{
			$sql="INSERT INTO `user`(`username`, `password`, `name`,`surname`,`email`,`phone`,`driving_licence`,`living_place`,`profession`,`rate`) VALUES (?,?,?,?,?,?,?,?,?,?)";
			$run =$dbh->prepare($sql);
    ...
    if(isset($pic_name)){
        ...
        echo 'You should select a file to upload !!';
			...
			$sql="INSERT INTO `user`(`username`, `password`, `name`,`surname`,`email`,`phone`,`driving_licence`,`living_place`,`profile_pic`,`profession`,`rate`) VALUES (?,?,?,?,?,?,?,?,?,?,?)";
			$run =$dbh->prepare($sql);
