...
//Purpose: greek language labels used inside the system
 ...
 //Chart 
  ...
  //Login History Labels
	$loginTimeStamp = "Timestamp Σύνδεσης";
	$logoutTimeStamp = "Timestamp Αποσύνδεσης";
	$loginDevice = "Συσκευή σύνδεσης";
	$safeKey = "Κλειδί Ασφαλείας";
...
//========================================================
   ...
   $password_change_request_from_index = "Αποστολή αίτησης αλλαγής κωδικού πρόσβασης στο ηλεκτρονικό ταχυδρομείο";
   ...
   $reminder = "Υπενθύμιση";
   $reminder_message = "Έχετε μη αναγνωσμένα μηνύματα, ελέγξτε τα εισερχόμενά σας";
   $unknown = "Άγνωστο";
   $yes = "Ναι";
   $no = "Όχι";
   $active = "Ενεργός";
   ...
   $username_in_user = "Το όνομα χρήστη χρησιμοποιείται από άλλον λογαριασμό";
?>