...
<body>
  ...
  <form method="post" action="php/update/update_court_db.php" enctype="multipart/form-data">
	     ...
	     <div class="form-row">
                ...
                <div class="col"><button class="btn btn-primary" name='submit' type="submit" style="width:100%;">Υποβολή</button></div>
				<div class="col"><button class="btn btn-primary" type="button" id='delete_court' style="width:100%;">Διαγραφή</button></div>
