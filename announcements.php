...
<body>
   ...
   <div class="annoucements-look">
        <form method="post" action="./php/insert/insert_announcement.php" style="background-color:rgba(238,238,238,0.74);margin:0px;">
            ...
            <div class="form-group"><button class="btn btn-primary btn-block" type="submit">Ανακοίνωση</button></div>
        </form>
    </div>
	</div>
	...
	<div class="annoucements-look element">
        <form  method="post" style="background-color:rgba(238,238,238,0.74);margin:0px;">
